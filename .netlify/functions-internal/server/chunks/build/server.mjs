...
const _sfc_main$h = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<header${ssrRenderAttrs(mergeProps({ class: "the-header" }, _attrs))} data-v-b6b11be4><h1 class="the-header__title" data-v-b6b11be4> Koronkowe Świeczki <p class="title__slogan" data-v-b6b11be4>…bo najwięcej szczęścia dają małe zachwyty</p></h1><div class="the-header__social-media" data-v-b6b11be4><a href="https://www.facebook.com/profile.php?id=100089067432296" target="_blank" data-v-b6b11be4>`);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(rootStore).homeData) {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "home-intro" }, _attrs))} data-v-ad4090bf><img class="intro__logo"${ssrRenderAttr("src", unref(rootStore).homeData.intro.logo)} alt="Koronkowe Świeczki Logo" data-v-ad4090bf><div class="intro__content" data-v-ad4090bf>`);
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!unref(accepted)) {
        ...
        _push(`</div><p class="wrapper__name" data-v-ee9473fb>Pliki cookies</p><hr class="wrapper__line" data-v-ee9473fb><div class="wrapper__content" data-v-ee9473fb> Ta strona używa plików cookies.<br data-v-ee9473fb> Jeśli nie zmienisz ustawień, zostaną zapisane w pamięci Twojego urządzenia. </div><button class="wrapper__button" data-v-ee9473fb>Akceptuję</button></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
    };
