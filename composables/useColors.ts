...
export default () => {
	const colors: Color[] = [
		...
		{ id: '0355', color: '#3B3E65', name: 'Granatowy', available: true, smell: 'Męski wieczór' },
		{ id: '0356', color: '#F9EFBE', name: 'Jasnożółty', customName: 'Cytrynowy', available: true, smell: 'Księżycowy ogród' },
		...
		{ id: '1588B', color: '#F5E2FC', name: 'New|jasny fioletowy', customName: 'Fioletowy pastelowy', available: true },
		{ id: '1626A', color: '#D9E2FF', name: 'New|jasny niebieskoszary', available: false, smell: 'Lawendowe pole' },
